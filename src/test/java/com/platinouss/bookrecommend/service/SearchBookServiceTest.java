...
class SearchBookServiceTest {
    ...
    void tes1() throws IOException {
        List<BookDto> bookDto =  searchBookService.search("잘될 수밖에 없는 너에게");
    ...
    void test2() throws IOException {
        List<BookDto> bookDto =  searchBookService.search("철학");
    ...
    void test3() throws IOException {
        List<BookDto> bookDto =  searchBookService.search("^~!");
